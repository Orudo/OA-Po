            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form role="form" action="/servlet/SendMessage">
                                    <div class="form-group">
                                        <label>Receiver</label>
                                        <input class="form-control" name="to" placeholder="Enter text">
                                    </div>
                                    <div class="form-group">
                                        <label>Content</label>
                                    ...
                                    <button type="submit" class="btn btn-success btn-outline">Send</button>
